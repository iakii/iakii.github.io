const { Fragment, lazy, useContext, useEffect, useMemo, useRef, useState } =
  React;
 ...
 * @returns {Promise<string | null | undefined>} babel对象字符串
 */
const babelJsx2Js = async (reactCode) => {
  try {
 ...
 */
const injectScript2Js = async (transformed) => {
