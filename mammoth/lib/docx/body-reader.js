...
function BodyReader(options) {
    ...
    function readRunProperties(element) {
        return readRunStyle(element).map(function(style) {
            ...
            var color= element.firstOrEmpty("w:color").attributes["w:val"];
            ...
            return {
                ...
                color: !color|| color === "auto" ? null :  "#" + `${color}`.toLocaleLowerCase()
            };
        });
    }
    ...
    function readDrawingElement(element) {
        ...
        var blips = element
            ...
            .getElementsByTagName("a:blip");
             ...
             var picture = element .getElementsByTagName("a:graphic")
            .getElementsByTagName("a:graphicData")
            .getElementsByTagName("pic:pic")


            var dimensions =  element.first('wp:extent') ||
            picture    .getElementsByTagName('pic:spPr')
    ...
    function readImageData(element) {
        ...
        if (relationshipId) {
            return readImage(
                ...
                {
                    altText: element.attributes["o:title"],
                    height: null,
                    width: null
                });
        } else {
